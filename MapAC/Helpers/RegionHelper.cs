...
namespace MapAC
{
    public static class RegionHelper
    {
        ...
        /// </summary>
        private static byte[,] landColor_tod_snow = new byte[33, 3]{
            {191, 196, 201}, // 0 - BarrenRock - 0x06006d47
            {191, 196, 201}, // 1 - Grassland - 0x06006d47
            ...
            {175, 179, 178}, // 9 - PatchyGrassland - 0x06006d4b
        ...
        private static byte[,] landColor_acdm_snow = new byte[33, 3]{
            {101, 81, 46}, // 0 - BarrenRock - 0x0500145c
            {234, 247, 254}, // 1 - Grassland - 0x05001464
            {133, 133, 145}, // 2 - Ice - 0x05001468
            {200, 209, 212}, // 3 - LushGrass - 0x05001888
            {83, 46, 11}, // 4 - MarshSparseSwamp - 0x05001467
            {234, 247, 254}, // 5 - MudRichDirt - 0x05001464
            {48, 44, 50}, // 6 - ObsidianPlain - 0x05001463
            {133, 133, 145}, // 7 - PackedDirt - 0x05001468
            {200, 209, 212}, // 8 - PatchyDirt - 0x05001888
            {234, 247, 254}, // 9 - PatchyGrassland - 0x05001464
            {166, 116, 59}, // 10 - sand-yellow - 0x0500145d
            {234, 247, 254}, // 11 - sand-grey - 0x05001464
            {133, 133, 145}, // 12 - sand-rockStrewn - 0x05001468
            {128, 81, 49}, // 13 - SedimentaryRock - 0x050014a7
            {133, 133, 145}, // 14 - SemiBarrenRock - 0x05001468
            {234, 247, 254}, // 15 - Snow - 0x05001464
            {63, 110, 133}, // 16 - WaterRunning - 0x0500146a
            {23, 81, 58}, // 17 - WaterStandingFresh - 0x05001461
            {34, 82, 101}, // 18 - WaterShallowSea - 0x0500146c
            {46, 78, 96}, // 19 - WaterShallowStillSea - 0x05001469
            {46, 61, 84}, // 20 - WaterDeepSea - 0x0500146b
            {234, 247, 254}, // 21 - forestfloor - 0x05001464
            {63, 110, 133}, // 22 - FauxWaterRunning - 0x0500146a
            {33, 41, 30}, // 23 - SeaSlime - 0x05001827
            {101, 81, 46}, // 24 - Argila - 0x0500145c
            {47, 36, 36}, // 25 - Volcano1 - 0x0500181f
